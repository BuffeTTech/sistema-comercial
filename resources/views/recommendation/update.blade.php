                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('recommendation.update', ['buffet'=>$buffet->slug,'recommendation'=>$recommendation]) }}">
                        ...
                        <div>
                            ...
                            <textarea name="content" id="content" cols="40" rows="10" class="height-500 width-500" placeholder="Conteudo da recomendação">{{ old('content') ?? $recommendation->content}}</textarea>
