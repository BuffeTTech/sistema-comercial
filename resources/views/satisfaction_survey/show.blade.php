                ...
                <div class="p-6 text-gray-900 float-left" style="width: 50%; border-right: 3px solid #000000;">
                    <div class="bg-gray-50 border-b-2 border-gray-200">
                        ...
                        <div class="flex items-center ml-auto float-down">
                            <a href="{{ route('survey.edit', [$question['questions']->id]) }}" class="bg-amber-300 hover:bg-amber-500 text-black font-bold py-2 px-4 rounded">
                                    ...
                                    @else
                                        ...
                                        <tr class="bg-white">
                                            ...
                                            <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center">
                                                <a href="{{ route('bookings.show', [$value->booking_id, $value->buffet->id]) }}" class="font-bold text-blue-500 hover:underline">{{ $value->bookings['name_birthdayperson'] }}</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    @endif
