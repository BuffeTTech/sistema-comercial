                    ...
                    <div class="card-header pb-0 d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            @can('view next bookings')
                                <a href="{{ route('booking.list', ['buffet'=>$buffet->slug, 'format'=>'pendent']) }}" class="btn btn-outline-primary btn-sm fs-6 btn-tooltip" title="Criar decoração">Listar Reservas Pendentes</a> 
                            @endcan  
                            @can('view party mode') 
                                @if($current_party)
