            ...
            <div class="col-12">
                ...
                <nav
                    ...
                    <div class="container-fluid">
                        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="{{ route('buffet.dashboard', ['buffet'=>$buffet]) }}">
                        ...
                        <div class="collapse navbar-collapse" id="navigation">
                            <ul class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link me-2" href="{{ route('profile-static', ['buffet'=>$buffet]) }}">
                                        <i class="fa fa-user opacity-6 text-dark me-1"></i>
                                        Profile
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link me-2" href="{{ route('sign-up-static', ['buffet'=>$buffet]) }}">
                                        <i class="fas fa-user-circle opacity-6 text-dark me-1"></i>
                                        Sign Up
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link me-2" href="{{ route('sign-in-static', ['buffet'=>$buffet]) }}">
