@extends('layouts.app', ['class' => 'g-sidenav-show bg-gray-100 rtl', 'buffet'=>$buffet])
...
@section('content')
    ...
    <aside
        ...
        <div class="collapse navbar-collapse px-0 w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link " href="{{ route('buffet.dashboard', ['buffet'=>$buffet->slug]) }}">
                        <div
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{ route('page', ['page' => 'tables', 'buffet'=>$buffet->slug]) }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{ route('page', ['page' => 'tables', 'buffet'=>$buffet]) }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{ route('page', ['page' => 'virtual-reality', 'buffet'=>$buffet]) }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('page', ['page' => 'rtl', 'buffet'=>$buffet]) }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{ route('page', ['page' => 'profile-static', 'buffet'=>$buffet]) }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
