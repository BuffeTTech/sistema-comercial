            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 float-left" style="width: 50%; border-right: 3px solid #000000;">
                    <div class="bg-gray-50 border-b-2 border-gray-200">
                        <p><strong>Nome do Funcionário:</strong> {{ $employee->main_theme }}</p><br>
                        <p><strong>Email:</strong> {{ $employee->slug }}</p><br>
                        <p><strong>Cargo:</strong>{{$employee->roles}}</p><br>
                        @php
                    ...
                    <div class="flex items-center ml-auto float-down">
                        <a href="{{ route('employee.edit', ['buffet'=>$buffet, 'employee'=>$employee->slug]) }}" class="bg-amber-300 hover:bg-amber-500 text-black font-bold py-2 px-4 rounded">
