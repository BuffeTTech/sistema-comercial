                            ...
                            <form action="">
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" placeholder="Minimo de dias de antecedencia" id="min_days_booking" name="min_days_booking" value="{{ old('min_days_booking') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" placeholder="Maximo de dias que a reserva indisponivel pode recomendar" id="max_days_unavaiable_booking" name="max_days_unavaiable_booking" value="{{ old('max_days_unavaiable_booking') }}">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Instagram do Buffet" id="buffet_instagram" name="buffet_instagram" value="{{ old('buffet_instagram') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Instagram do Buffet" id="buffet_linkedin" name="buffet_linkedin" value="{{ old('buffet_linkedin') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Facebook do Buffet" id="buffet_facebook" name="buffet_facebook" value="{{ old('buffet_facebook') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="WhatsApp do Buffet" id="buffet_whatsapp" name="buffet_whatsapp" value="{{ old('buffet_whatsapp') }}">
                                ...
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input class="form-control" type="number" placeholder="O quanto afeta?" id="children_price_adjustment" name="children_price_adjustment" value="{{ old('children_price_adjustment') }}">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="range" min="0" step="1" class="form-range" id="disabledRange" id="child_age_limit" name="child_age_limit" value="{{ old('child_age_limit') }}">
